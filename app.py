...
with st.sidebar:
    ...
    api_key = st.text_input("Enter Cohere API Key:")
...
if st.session_state['settings_updated']:
    ...
    c30, c31, c32 = st.columns([0.2, 0.1, 2.5])
    ...
    with c30:
        ...
        st.image("Imgs\cohere2.png", width=60)
    
    with c32:
    
        st.title("Document : Question and Answer Chatbot")
